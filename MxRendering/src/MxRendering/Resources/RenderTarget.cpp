...
ID3D12Resource* MxRendering::Resources::MxRenderTarget::Resource(UINT Index /*= 0*/)
{
...
CD3DX12_GPU_DESCRIPTOR_HANDLE MxRendering::Resources::MxRenderTarget::Srv(UINT Index /*= 0*/)
{
	if (Index + 1 <= mRTNum)
	{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE MxRendering::Resources::MxRenderTarget::Rtv(UINT Index /*= 0*/)
{
	if (Index + 1 <= mRTNum)
	{
...
void MxRendering::Resources::MxRenderTarget::BuileRenderTarget(CD3DX12_CPU_DESCRIPTOR_HANDLE hCpuSrv, CD3DX12_GPU_DESCRIPTOR_HANDLE hGpuSrv)
{
	mhCpuSrv = hCpuSrv;
	mhGpuSrv = hGpuSrv;
...
void MxRendering::Resources::MxRenderTarget::BuildDescriptors()
{
...
void MxRendering::Resources::MxRenderTarget::BuildResource()
{
...
void MxRendering::Resources::MxRenderTarget::RTTransition(ID3D12GraphicsCommandList* cmdList, D3D12_RESOURCE_STATES stateBefore, D3D12_RESOURCE_STATES stateAfter)
{
...
void MxRendering::Resources::MxRenderTarget::RTClearView(ID3D12GraphicsCommandList* cmdList, const FLOAT ColorRGBA[4], UINT NumRects, _In_reads_(NumRects) const D3D12_RECT* pRects)
{
	for (UINT i = 0; i < mRTNum; i++)
	{
