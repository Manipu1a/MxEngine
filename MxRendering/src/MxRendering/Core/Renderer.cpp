...
void MxRendering::Core::MxRenderer::SaveMesh(std::unique_ptr<MeshGeometry>& mgo)
{
	mGeometries[mgo->Name] = std::move(mgo);
}

void MxRendering::Core::MxRenderer::SaveTexturePath(const std::string& name, std::wstring& path)
{
	MaterialTex.insert({ name, path });
}

void MxRendering::Core::MxRenderer::Tick(const GameTimer& gt)
{
	Update(gt);
	Draw(gt);
}

void MxRendering::Core::MxRenderer::OnResize()
{
	assert(md3dDevice);
	assert(mSwapChain);
...
void MxRendering::Core::MxRenderer::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	//UpdateCamera(gt);
...
void MxRendering::Core::MxRenderer::Draw(const GameTimer& gt)
{
	//mCommandList->Close();
...
void MxRendering::Core::MxRenderer::CreateRtvAndDsvDescriptorHeaps()
{
...
bool MxRendering::Core::MxRenderer::InitDirect3D()
{
...
void MxRendering::Core::MxRenderer::CreateCommandObjects()
{
...
void MxRendering::Core::MxRenderer::CreateSwapChain()
{
...
void MxRendering::Core::MxRenderer::FlushCommandQueue()
{
	// Advance the fence value to mark commands up to this fence point.
	mCurrentFence++;
...
ID3D12Resource* MxRendering::Core::MxRenderer::CurrentBackBuffer() const
{
	return mSwapChainBuffer[mCurrBackBuffer].Get();
}

D3D12_CPU_DESCRIPTOR_HANDLE MxRendering::Core::MxRenderer::CurrentBackBufferView() const
{
...
void MxRendering::Core::MxRenderer::LogAdapters()
{
	UINT i = 0;
...
void MxRendering::Core::MxRenderer::LogAdapterOutputs(IDXGIAdapter* adapter)
{
	UINT i = 0;
...
void MxRendering::Core::MxRenderer::LogOutputDisplayModes(IDXGIOutput* output, DXGI_FORMAT format)
{
	UINT count = 0;
	UINT flags = 0;
...
void MxRendering::Core::MxRenderer::OnKeyboardInput(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void MxRendering::Core::MxRenderer::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void MxRendering::Core::MxRenderer::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void MxRendering::Core::MxRenderer::UpdateCamera(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::UpdateObjectCBs(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::UpdateMaterialCBs(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::UpdateMainPassCB(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::UpdateShadowTransform(const GameTimer& gt)
{
...
void MxRendering::Core::MxRenderer::UpdateShadowPassCB(const GameTimer& gt)
{
	XMMATRIX view = XMLoadFloat4x4(&mLightView);
	XMMATRIX proj = XMLoadFloat4x4(&mLightProj);
	XMMATRIX viewProj = XMMatrixMultiply(view, proj);
...
void MxRendering::Core::MxRenderer::BuildPrefilterPassCB()
{
	for (int i = 0; i < gPrefilterLevel; ++i)
	{
...
void MxRendering::Core::MxRenderer::UpdateCubeMapFacePassCBs()
{
	for (int i = 0; i < 6; ++i)
	{
...
void MxRendering::Core::MxRenderer::BuildDescriptorHeaps()
{
...
void MxRendering::Core::MxRenderer::BuildConstantBufferViews()
{

}

void MxRendering::Core::MxRenderer::BuileSourceBufferViews()
{
...
void MxRendering::Core::MxRenderer::BuildRootSignature()
{
	//创建描述符表
...
void MxRendering::Core::MxRenderer::BuildShadersAndInputLayout()
{
...
void MxRendering::Core::MxRenderer::BuildShapeGeometry()
{
...
void MxRendering::Core::MxRenderer::BuildPSOs()
{
...
void MxRendering::Core::MxRenderer::BuildFrameResources()
{
...
void MxRendering::Core::MxRenderer::BuildRenderItems()
{
...
void MxRendering::Core::MxRenderer::BuildCubeFaceCamera(float x, float y, float z)
{
...
void MxRendering::Core::MxRenderer::BuildCubeDepthStencil()
{
	// Create the depth/stencil buffer and view.
	D3D12_RESOURCE_DESC depthStencilDesc;
	depthStencilDesc.Dimension = D3D12_RESOURCE_DIMENSION_TEXTURE2D;
...
void MxRendering::Core::MxRenderer::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void MxRendering::Core::MxRenderer::DrawSceneToShadowMap()
{
...
void MxRendering::Core::MxRenderer::DrawSceneToCubeMap()
{
...
void MxRendering::Core::MxRenderer::DrawIrradianceCubeMap()
{
...
void MxRendering::Core::MxRenderer::DrawPrefilterCubeMap()
{
...
void MxRendering::Core::MxRenderer::DrawGBufferMap()
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 7> MxRendering::Core::MxRenderer::GetStaticSamplers()
{
...
void MxRendering::Core::MxRenderer::LoadTexture()
{
...
void MxRendering::Core::MxRenderer::BuildMaterial()
{
	int matIndex = 0;
...
HWND MxRendering::Core::MxRenderer::MainWnd() const
{
	return mhMainWnd;
}

float MxRendering::Core::MxRenderer::AspectRatio() const
{
