...
#include "MxUI/Imgui/imgui_internal.h"
#include "MxUI/Internal/Converter.h"

MxUI::Panels::PanelWindow::PanelWindow(const std::string& p_name, bool p_opened,
                                       const UICommon::PanelWindowSettings& p_floatingPanelSettings) :
name(p_name),
...
void MxUI::Panels::PanelWindow::Open()
{
    if (!m_opened)
    {
        m_opened = true;
...
void MxUI::Panels::PanelWindow::Close()
{
    if (m_opened)
    {
        m_opened = false;
...
void MxUI::Panels::PanelWindow::Focus()
{
    ImGui::SetWindowFocus((name + m_panelID).c_str());
}

void MxUI::Panels::PanelWindow::SetOpened(bool p_value)
{
    if (p_value != m_opened)
    {
        m_opened = p_value;
...
bool MxUI::Panels::PanelWindow::IsOpened() const
{
    return m_opened;
}

bool MxUI::Panels::PanelWindow::IsHovered() const
{
    return m_hovered;
}

bool MxUI::Panels::PanelWindow::IsFocused() const
{
    return m_focused;
}

bool MxUI::Panels::PanelWindow::IsAppearing() const
{
...
void MxUI::Panels::PanelWindow::ScrollToBottom()
{
    m_mustScrollToBottom = true;
}

void MxUI::Panels::PanelWindow::ScrollToTop()
{
    m_mustScrollToTop = true;
}

bool MxUI::Panels::PanelWindow::IsScrolledToBottom() const
{
    return m_scrolledToBottom;
}

bool MxUI::Panels::PanelWindow::IsScrolledToTop() const
{
    return m_scrolledToTop;
}

void MxUI::Panels::PanelWindow::Draw_Impl()
{
    if (m_opened)
	{
